...
public interface GoodsBannerMapper {
	 ...
	 * @return 受影响的行数
	 */
	int insertSelective(GoodsBanner record);
	 ...
	 * @return 受影响的行数
	 */
	int updateByPrimaryKey(GoodsBanner record);
	 ...
	 * @return 受影响的行数
	 */
	int updateByPrimaryKeySelective(GoodsBanner record);
	 ...
	 * @return 对象
	 */
	GoodsBanner selectByPrimaryKey(Long id);
