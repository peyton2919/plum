package cn.peyton.plum.core.mybatis;
...
/**
 * <h3>配置MyBatis相关文件</h3>
 * <h>用注解方式完成，不用在配置xml文件</h>
 * <h4>在程序入口处需要扫描mapper所在文件目录</h4>
 * <pre>
 * @email: <a href="mailto:fz2919@tom.com">fz2919@tom.com</a>
 * @project name: plum
 * @class name: cn.peyton.plum.core.mybatis.MyBatisConfig.java
 * @create date: 2021/11/1 18:50
