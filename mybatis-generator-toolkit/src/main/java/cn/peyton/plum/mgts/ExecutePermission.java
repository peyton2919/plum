 ...
 * </pre>
 */
public final class ExecutePermission {

    public static String POJO = "cn.peyton.plum.permission.pojo";
    public static String MAPPER = "cn.peyton.plum.permission.mapper";
    public static String PARAM = "cn.peyton.plum.permission.param";
    public static String PATH = "f:/permission/";
   ...
   //
   //     generation.create("sys_",PATH,MAPPER,POJO,true);
   //     generation.createParamCompatConvert(null,"sys_","","tb_,sys_",PATH,PARAM);
